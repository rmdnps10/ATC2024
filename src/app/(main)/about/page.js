        ...
        <div>
          <blockquote>
            ...
            <p>
              ...
              을 통해 불가능하다고 생각한 것들에 대한 미래 크리에이터들의
          ...
          <blockquote>
            ...
            <p>
              <span>
                반갑습니다 ! ATC 2024 「코끼리를 냉장고에 넣는 방법」의
                크리에이티브 디렉터를 맡은 임동준입니다.
              </span>
              <br />
              <br />
              아트&테크놀로지는 무엇을 하는 학과일까요? 4학년이 된 지금도 이
              질문에 답하기에 참 많은 생각이 스쳐갑니다. 명쾌한 한 문장으로
              설명하기는 어려워도 「코끼리를 냉장고에 넣는 방법」 그 문장이
              질문과 닮아있다는 생각을 합니다. 이 문장은 보는 사람으로 하여금
              독특하고 이상한 생각을 하게 만들더라구요. <br />
              <br />
              많은 아테커가 모여, 전시를 만들었습니다. 평소 낯설었던 아텍에 대해
              알아가는 자리가 되었으면 합니다. 웹뿐만 아니라 서강대학교 하비에르
              관에서도 진행됩니다. 부담 없이 방문해 주세요. 많은 관심
              부탁드립니다. 감사합니다.
            </p>
            <Image
              src="images/about/quotation.svg"
