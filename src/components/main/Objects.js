...
export default function Objects() {
  ...
  return (
    <>
      <pointLight color="blue" position={[8, -25, 5]} intensity={10} />
      <pointLight color="red" position={[0, -height * 2.25, 5]} intensity={20} />
      <Item color="9822ff" position={[0, 2, 0]}>
        <boxGeometry />
      </Item>
      <Item color="blue" position={[width / 6, -height * 0.5, 0]}>
        <dodecahedronGeometry />
      </Item>
      <Item color="gray" position={[-width / 5, -height * 1.8, -2]}>
        <coneGeometry args={[1, 1, 6]} />
      </Item>
      <Item color="purple" position={[width / 4 + 4, -height * 2, 0]}>
        <coneGeometry args={[1.5, 2, 3]} />
      </Item>
      <Item color="orange" position={[-width / 12 - 4.5, -height * 2.25, 0.5]}>
